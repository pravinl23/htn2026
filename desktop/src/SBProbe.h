// SBProbe: what does this page ACTUALLY expose for one combo box?
//
...
+ (NSDictionary<NSString *, id> *)probeComboBoxUnderWindow:(id<SBAXNode>)window
...
/// The label SBProbe matches against: title, description, the label element, placeholder, help.
+ (nullable NSString *)labelOfComboBox:(id<SBAXNode>)node;
...
+ (nullable id<SBAXNode>)toggleButtonForComboBox:(id<SBAXNode>)comboBox;
...
+ (NSDictionary<NSString *, id> *)summaryOfNode:(nullable id<SBAXNode>)node;
