// SBField: the shared model of one captured interactive element. Mirrors `CapturedField` in
...
extern NSString *const SBKindText;
extern NSString *const SBKindEmail;
extern NSString *const SBKindTel;
extern NSString *const SBKindURL;
extern NSString *const SBKindNumber;
extern NSString *const SBKindDate;
extern NSString *const SBKindMonth;
extern NSString *const SBKindTextArea;
extern NSString *const SBKindSelect;
extern NSString *const SBKindRadio;
extern NSString *const SBKindCheckbox;
extern NSString *const SBKindFile;
extern NSString *const SBKindButton;
extern NSString *const SBKindLink;
...
extern NSString *const SBKindItem;
extern NSString *const SBKindOther;

// What a `file` field wants (serialized as `uploadKind`). The core maps them to resumePath / coverLetterPath.
extern NSString *const SBUploadKindResume;       // "resume"
extern NSString *const SBUploadKindCoverLetter;  // "coverLetter"
extern NSString *const SBUploadKindOther;        // "other": never answered

@interface SBField : NSObject <NSCopying>

/// Stable across reloads of the same window. Never contains the field's value.
@property (nonatomic, copy) NSString *signature;
@property (nonatomic, copy) NSString *label;
/// One of the SBKind* strings. Defaults to SBKindText.
...
/// Irreversible action: never pressed by Shabang.
@property (nonatomic) BOOL locked;
@property (nonatomic, copy, nullable) NSString *context;
/// `file` fields only: one of the SBUploadKind* strings. Serialized as `uploadKind`.
...
// ---------- Shabang anywhere (docs/anywhere.md): generic hints for the affordance layer ----------
