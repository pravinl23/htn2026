// SBOverlayWindow: the glass Shabang draws on. One borderless, transparent, click-through, non-activating panel per
...
@interface SBOverlayWindow : NSObject

/// The display arrangement the panels were built for. Build models against THIS layout.
@property (nonatomic, readonly) SBScreenLayout *layout;
